...
public class DynamicButton extends DrawableRectangle{
    ...
    @Override
    public void adChild(de.jakobimatrix.intervalometer.Drawable child){
        throw new IllegalArgumentException( "DynamicButton::adChild: This function should not be called. This is not a drawable!" );
    }
    @Override
    public void adChild(de.jakobimatrix.intervalometer.Drawable child, Pos3d relative_translation_2_parent){
        throw new IllegalArgumentException( "DynamicButton::adChild: This function should not be called. This is not a drawable!" );
    }
    @Override
