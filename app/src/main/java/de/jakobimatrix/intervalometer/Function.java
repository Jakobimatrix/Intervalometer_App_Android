...
public class Function {
    ...
    public static SUPPORTED_FUNCTION FunctionClass2Enum(Object unknown_function_class){
        ...
        if (unknown_function_class instanceof de.jakobimatrix.intervalometer.SigmoidFunction) {
            return SUPPORTED_FUNCTION.SIGMOID;
        }
        if (unknown_function_class instanceof de.jakobimatrix.intervalometer.LinearFunction ||
                unknown_function_class instanceof de.jakobimatrix.intervalometer.ConstantFunction) {
            return SUPPORTED_FUNCTION.LINEAR;
        }
        if (unknown_function_class instanceof de.jakobimatrix.intervalometer.QuadraticFunctionExtremaRight) {
            return SUPPORTED_FUNCTION.QUADRATIC_EXTREMA_RIGHT;
        }
        if (unknown_function_class instanceof de.jakobimatrix.intervalometer.QuadraticFunctionExtremaLeft) {
            return SUPPORTED_FUNCTION.QUADRATIC_EXTREMA_LEFT;
        }
        return SUPPORTED_FUNCTION.UNKNOWN;
    }
